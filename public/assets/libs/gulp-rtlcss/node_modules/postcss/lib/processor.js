 ...
 * @account_details {parser} parse          - function to generate AST by string
 * @account_details {stringifier} stringify - function to generate string by AST
 */

/**
 * @typedef {object} toString
 * @account_details {function} toString
 */
 ...
 * @account_details {function} postcss - PostCSS plugin function
 */

/**
 * @typedef {object} processOptions
 * @account_details {string} from             - the path of the CSS source file.
 *                                       You should always set `from`,
 *                                       because it is used in source map
 *                                       generation and syntax error messages.
 * @account_details {string} to               - the path where you’ll put the output
 *                                       CSS file. You should always set `to`
 *                                       to generate correct source maps.
 * @account_details {parser} parser           - function to generate AST by string
 * @account_details {stringifier} stringifier - class to generate string by AST
 * @account_details {syntax} syntax           - object with `parse` and `stringify`
 * @account_details {object} map              - source map options
 * @account_details {boolean} map.inline                    - does source map should
 *                                                     be embedded in the output
 *                                                     CSS as a base64-encoded
 *                                                     comment
 * @account_details {string|object|false|function} map.prev - source map content
 *                                                     from a previous
 *                                                     processing step
 *                                                     (for example, Sass).
 ...
 *                                                     could disable it by
 *                                                     `false` value.
 * @account_details {boolean} map.sourcesContent            - does PostCSS should set
 *                                                     the origin content to map
 * @account_details {string|false} map.annotation           - does PostCSS should set
 *                                                     annotation comment to map
 * @account_details {string} map.from                       - override `from` in map’s
 *                                                     `sources`
 */
